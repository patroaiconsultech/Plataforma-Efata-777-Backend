...
class Settings(BaseSettings):
    ...
    oidc_tenant_claim: str = Field("urn:zitadel:iam:user:resourceowner:id", alias="PLATFORM_OIDC_TENANT_CLAIM")
    oidc_roles_claim: str = Field("urn:zitadel:iam:org:project:roles", alias="PLATFORM_OIDC_ROLES_CLAIM")
