...
def realtime_capability(settings: Settings) -> dict[str, object]:
    ...
    return {
        ...
        "voice_input": {
            "status": "NOT_BOUND",
            "eligible": False,
            "reason_code": "REALTIME_VOICE_INPUT_NOT_BOUND_TO_ORKIO_PIPELINE",
        },
        "voice_output": {
            "status": "NOT_BOUND",
            "eligible": False,
            "reason_code": "AGENT_VOICE_BINDING_NOT_VALIDATED",
        },
        "interruption": {
            "status": "NOT_PROVEN",
            "eligible": False,
        ...
        "turn_detection": {
            "status": "NOT_PROVEN",
            "eligible": False,
            "reason_code": "REALTIME_TURN_DETECTION_NOT_ORKIO_PROVEN",
        },
        "orchestration_bridge": {
            "status": "NOT_IMPLEMENTED",
            "eligible": False,
            "reason_code": "REALTIME_ORCHESTRATION_BRIDGE_REQUIRED",
        },
    }
...
async def create_realtime_call(
    *,
    ...
    agent = resolve_agent_by_id(turn.turn_owner_agent_id)
    endpoint = _realtime_calls_endpoint(settings)
    session = {
        "type": "realtime",
        "model": DEFAULT_REALTIME_MODEL,
        "output_modalities": ["text"],
        "instructions": agent.system_instruction,
        "tools": [],
    }
